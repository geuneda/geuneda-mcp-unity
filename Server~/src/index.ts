...
import { registerClearConsoleLogsTool } from './tools/clearConsoleLogsTool.js';
import { registerUpdateComponentTool } from './tools/updateComponentTool.js';
import { registerInvokeMethodTool } from './tools/invokeMethodTool.js';
...
registerClearConsoleLogsTool(server, mcpUnity, toolLogger);
registerUpdateComponentTool(server, mcpUnity, toolLogger);
registerInvokeMethodTool(server, mcpUnity, toolLogger);
